...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'background': '#ffffff', 'primaryColor': '#3b82f6', 'primaryTextColor': '#000000', 'lineColor': '#ffffff' }}}%%

graph TD
    Start([PostgreSQL Database Service Selection]) --> Q1{What is your<br/>database size?}
    
    Q1 -->|Under 1 TiB| Q2{Do you need high<br/>availability 99.99%?}
    Q1 -->|1+ TiB| Q3{Do you need more<br/>than 5 read replicas?}
    
    Q2 -->|No| Q4{Do you need specific<br/>PostgreSQL extensions<br/>or latest versions?}
    Q2 -->|Yes| Q5{Is cost a primary<br/>constraint?}
    
    Q3 -->|Yes| Aurora[Amazon Aurora PostgreSQL]
    Q3 -->|No| Q6{Do you need<br/>global database<br/>capabilities?}
    
    Q4 -->|Yes| RDS[Amazon RDS PostgreSQL]
    Q4 -->|No| Q7{Is your workload<br/>write-heavy?}
    
    Q5 -->|Yes| Q8{Can you accept<br/>60-120s failover?}
    Q5 -->|No| Aurora
    
    Q6 -->|Yes| Aurora
    Q6 -->|No| Q9{Highly variable workload?<br/>Fast automatic scaling?}
    
    Q7 -->|Yes| Aurora
    Q7 -->|No| Q10{Development or<br/>test environment?}
    
    Q8 -->|Yes| RDS
    Q8 -->|No| Aurora
    
    Q9 -->|Yes| AuroraServerless[Aurora Serverless v2]
    Q9 -->|No| Q11{Do you need<br/>sub-second failover?}
    
    Q10 -->|Yes| RDS
    Q10 -->|No| Q12{Predictable steady<br/>workload?}
    
    Q11 -->|Yes| Aurora
    Q11 -->|No| Q13{Do you need fast<br/>cloning/QPM/CCM?}
    
    Q12 -->|Yes| RDS
    Q12 -->|No| Aurora
    
    Q13 -->|Yes| Aurora
    Q13 -->|No| Q14{Is I/O cost<br/>a concern?}
    
    Q14 -->|Yes| RDS
    Q14 -->|No| Aurora
    
    style Start fill:#e1f5ff
    style RDS fill:#ff9900,color:#000000
    style Aurora fill:#ff9900,color:#000000
    style AuroraServerless fill:#ff9900,color:#000000
```
